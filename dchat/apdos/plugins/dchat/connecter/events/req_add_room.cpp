...
Req_Add_Room::Req_Add_Room(std::string room_type, std::string room_name): Event("Req_Add_Room", REQ_ADD_ROOM) {
  boost::shared_ptr<std::map<std::string, boost::any> > data(new std::map<std::string, boost::any>());
  data->insert(std::make_pair("room_type", boost::any(room_type)));
